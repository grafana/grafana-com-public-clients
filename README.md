...
Renovate takes care of periodically generating PRs to update with the latest client, which causes the openapi action to regenerate the golang client. It uses https://grafana.com/api/openapi.json to download it.
