...
GetConnections Gets an instance's connectivity information (InfluxDB, OTEL, AWS private link, etc.)
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param instanceId id or slug of the instance
	@return ApiGetConnectionsRequest

Deprecated
*/
func (a *StacksAPIService) GetConnections(ctx context.Context, instanceId string) ApiGetConnectionsRequest {
	return ApiGetConnectionsRequest{
		ApiService: a,
		ctx:        ctx,
...
//
// Deprecated
func (a *StacksAPIService) GetConnectionsExecute(r ApiGetConnectionsRequest) (*FormattedApiInstanceConnections, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StacksAPIService.GetConnections")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetStackConnectionsV1Request struct {
	ctx        context.Context
	ApiService *StacksAPIService
	idOrSlug   string
}

func (r ApiGetStackConnectionsV1Request) Execute() (*StackConnectionsV1, *http.Response, error) {
	return r.ApiService.GetStackConnectionsV1Execute(r)
}

/*
GetStackConnectionsV1 Method for GetStackConnectionsV1

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param idOrSlug id or slug of the stack
	@return ApiGetStackConnectionsV1Request
*/
func (a *StacksAPIService) GetStackConnectionsV1(ctx context.Context, idOrSlug string) ApiGetStackConnectionsV1Request {
	return ApiGetStackConnectionsV1Request{
		ApiService: a,
		ctx:        ctx,
		idOrSlug:   idOrSlug,
...
// Execute executes the request
//
//	@return StackConnectionsV1
func (a *StacksAPIService) GetStackConnectionsV1Execute(r ApiGetStackConnectionsV1Request) (*StackConnectionsV1, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *StackConnectionsV1
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StacksAPIService.GetStackConnectionsV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/stacks/{idOrSlug}/connections"
	localVarPath = strings.Replace(localVarPath, "{"+"idOrSlug"+"}", url.PathEscape(parameterValueToString(r.idOrSlug, "idOrSlug")), -1)
