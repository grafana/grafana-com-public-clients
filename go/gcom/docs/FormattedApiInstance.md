...
**RegionSigilUrl** | **string** |  | 
**RegionAgentO11YUrl** | **string** |  | 
...
`func (o *FormattedApiInstance) GetOrgCreatedAt() string`

GetOrgCreatedAt returns the OrgCreatedAt field if non-nil, zero value otherwise.

### GetOrgCreatedAtOk

`func (o *FormattedApiInstance) GetOrgCreatedAtOk() (*string, bool)`

GetOrgCreatedAtOk returns a tuple with the OrgCreatedAt field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetOrgCreatedAt

`func (o *FormattedApiInstance) SetOrgCreatedAt(v string)`

SetOrgCreatedAt sets OrgCreatedAt field to given value.
...
GetRegionSigilUrl returns the RegionSigilUrl field if non-nil, zero value otherwise.

### GetRegionSigilUrlOk

`func (o *FormattedApiInstance) GetRegionSigilUrlOk() (*string, bool)`

GetRegionSigilUrlOk returns a tuple with the RegionSigilUrl field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetRegionSigilUrl sets RegionSigilUrl field to given value.


### GetRegionAgentO11YUrl

`func (o *FormattedApiInstance) GetRegionAgentO11YUrl() string`

GetRegionAgentO11YUrl returns the RegionAgentO11YUrl field if non-nil, zero value otherwise.

### GetRegionAgentO11YUrlOk

`func (o *FormattedApiInstance) GetRegionAgentO11YUrlOk() (*string, bool)`

GetRegionAgentO11YUrlOk returns a tuple with the RegionAgentO11YUrl field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetRegionAgentO11YUrl

`func (o *FormattedApiInstance) SetRegionAgentO11YUrl(v string)`

SetRegionAgentO11YUrl sets RegionAgentO11YUrl field to given value.
...
`func (o *FormattedApiInstance) GetLinksOk() (*[]LinksInner, bool)`
...
`func (o *FormattedApiInstance) SetLinks(v []LinksInner)`
