...
`func (o *FormattedApiStackRegion) GetSigilUrl() string`

GetSigilUrl returns the SigilUrl field if non-nil, zero value otherwise.

### GetSigilUrlOk

`func (o *FormattedApiStackRegion) GetSigilUrlOk() (*string, bool)`

GetSigilUrlOk returns a tuple with the SigilUrl field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetSigilUrl

`func (o *FormattedApiStackRegion) SetSigilUrl(v string)`

SetSigilUrl sets SigilUrl field to given value.


### GetAgentO11YUrl

`func (o *FormattedApiStackRegion) GetAgentO11YUrl() string`

GetAgentO11YUrl returns the AgentO11YUrl field if non-nil, zero value otherwise.

### GetAgentO11YUrlOk

`func (o *FormattedApiStackRegion) GetAgentO11YUrlOk() (*string, bool)`

GetAgentO11YUrlOk returns a tuple with the AgentO11YUrl field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAgentO11YUrl

`func (o *FormattedApiStackRegion) SetAgentO11YUrl(v string)`

SetAgentO11YUrl sets AgentO11YUrl field to given value.


### GetWorkflowEngineUrl

`func (o *FormattedApiStackRegion) GetWorkflowEngineUrl() string`

GetWorkflowEngineUrl returns the WorkflowEngineUrl field if non-nil, zero value otherwise.

### GetWorkflowEngineUrlOk

`func (o *FormattedApiStackRegion) GetWorkflowEngineUrlOk() (*string, bool)`

GetWorkflowEngineUrlOk returns a tuple with the WorkflowEngineUrl field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetWorkflowEngineUrl

`func (o *FormattedApiStackRegion) SetWorkflowEngineUrl(v string)`

SetWorkflowEngineUrl sets WorkflowEngineUrl field to given value.


### GetMobileGatewayUrl

`func (o *FormattedApiStackRegion) GetMobileGatewayUrl() string`

GetMobileGatewayUrl returns the MobileGatewayUrl field if non-nil, zero value otherwise.

### GetMobileGatewayUrlOk

`func (o *FormattedApiStackRegion) GetMobileGatewayUrlOk() (*string, bool)`

GetMobileGatewayUrlOk returns a tuple with the MobileGatewayUrl field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
`func (o *FormattedApiStackRegion) GetPdcHostname() string`

GetPdcHostname returns the PdcHostname field if non-nil, zero value otherwise.

### GetPdcHostnameOk

`func (o *FormattedApiStackRegion) GetPdcHostnameOk() (*string, bool)`

GetPdcHostnameOk returns a tuple with the PdcHostname field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetPdcHostname

`func (o *FormattedApiStackRegion) SetPdcHostname(v string)`

SetPdcHostname sets PdcHostname field to given value.
...
`func (o *FormattedApiStackRegion) GetReadyForStacks() bool`

GetReadyForStacks returns the ReadyForStacks field if non-nil, zero value otherwise.

### GetReadyForStacksOk

`func (o *FormattedApiStackRegion) GetReadyForStacksOk() (*bool, bool)`

GetReadyForStacksOk returns a tuple with the ReadyForStacks field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetReadyForStacks

`func (o *FormattedApiStackRegion) SetReadyForStacks(v bool)`
...
`func (o *FormattedApiStackRegion) GetLabels() map[string]interface{}`

GetLabels returns the Labels field if non-nil, zero value otherwise.

### GetLabelsOk

`func (o *FormattedApiStackRegion) GetLabelsOk() (*map[string]interface{}, bool)`
...
`func (o *FormattedApiStackRegion) SetLabels(v map[string]interface{})`

SetLabels sets Labels field to given value.

### HasLabels

`func (o *FormattedApiStackRegion) HasLabels() bool`
