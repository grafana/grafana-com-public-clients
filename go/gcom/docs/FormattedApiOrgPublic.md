...
### GetKapaDeflectorEnabled

`func (o *FormattedApiOrgPublic) GetKapaDeflectorEnabled() bool`

GetKapaDeflectorEnabled returns the KapaDeflectorEnabled field if non-nil, zero value otherwise.

### GetKapaDeflectorEnabledOk

`func (o *FormattedApiOrgPublic) GetKapaDeflectorEnabledOk() (*bool, bool)`

GetKapaDeflectorEnabledOk returns a tuple with the KapaDeflectorEnabled field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetKapaDeflectorEnabled

`func (o *FormattedApiOrgPublic) SetKapaDeflectorEnabled(v bool)`

SetKapaDeflectorEnabled sets KapaDeflectorEnabled field to given value.
