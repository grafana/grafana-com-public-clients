...
`func (o *PdcPrivateConnectivityInfo) GetAvailabilityZoneIds() []string`

GetAvailabilityZoneIds returns the AvailabilityZoneIds field if non-nil, zero value otherwise.

### GetAvailabilityZoneIdsOk

`func (o *PdcPrivateConnectivityInfo) GetAvailabilityZoneIdsOk() (*[]string, bool)`
...
`func (o *PdcPrivateConnectivityInfo) SetAvailabilityZoneIds(v []string)`

SetAvailabilityZoneIds sets AvailabilityZoneIds field to given value.

### HasAvailabilityZoneIds

`func (o *PdcPrivateConnectivityInfo) HasAvailabilityZoneIds() bool`
