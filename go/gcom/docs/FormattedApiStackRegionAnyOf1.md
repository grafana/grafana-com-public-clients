...
`func (o *FormattedApiStackRegionAnyOf1) GetSigilUrl() string`

GetSigilUrl returns the SigilUrl field if non-nil, zero value otherwise.

### GetSigilUrlOk

`func (o *FormattedApiStackRegionAnyOf1) GetSigilUrlOk() (*string, bool)`
...
`func (o *FormattedApiStackRegionAnyOf1) SetSigilUrl(v string)`
...
`func (o *FormattedApiStackRegionAnyOf1) GetAgentO11YUrl() string`

GetAgentO11YUrl returns the AgentO11YUrl field if non-nil, zero value otherwise.

### GetAgentO11YUrlOk

`func (o *FormattedApiStackRegionAnyOf1) GetAgentO11YUrlOk() (*string, bool)`
...
`func (o *FormattedApiStackRegionAnyOf1) SetAgentO11YUrl(v string)`
...
`func (o *FormattedApiStackRegionAnyOf1) GetWorkflowEngineUrl() string`

GetWorkflowEngineUrl returns the WorkflowEngineUrl field if non-nil, zero value otherwise.

### GetWorkflowEngineUrlOk

`func (o *FormattedApiStackRegionAnyOf1) GetWorkflowEngineUrlOk() (*string, bool)`
...
`func (o *FormattedApiStackRegionAnyOf1) GetSlackServiceUrl() string`

GetSlackServiceUrl returns the SlackServiceUrl field if non-nil, zero value otherwise.

### GetSlackServiceUrlOk

`func (o *FormattedApiStackRegionAnyOf1) GetSlackServiceUrlOk() (*string, bool)`
...
`func (o *FormattedApiStackRegionAnyOf1) SetSlackServiceUrl(v string)`
...
`func (o *FormattedApiStackRegionAnyOf1) GetPdcHostname() string`

GetPdcHostname returns the PdcHostname field if non-nil, zero value otherwise.

### GetPdcHostnameOk

`func (o *FormattedApiStackRegionAnyOf1) GetPdcHostnameOk() (*string, bool)`
...
`func (o *FormattedApiStackRegionAnyOf1) SetPdcHostname(v string)`
