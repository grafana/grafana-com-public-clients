...
// checks if the Api1AnyOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Api1AnyOf{}

// Api1AnyOf struct for Api1AnyOf
type Api1AnyOf struct {
...
func (o Api1AnyOf) ToMap() (map[string]interface{}, error) {
...
func (o *Api1AnyOf) UnmarshalJSON(data []byte) (err error) {
	...
	varApi1AnyOf := _Api1AnyOf{}

	err = json.Unmarshal(data, &varApi1AnyOf)

	if err != nil {
		return err
	}

	*o = Api1AnyOf(varApi1AnyOf)
...
type NullableApi1AnyOf struct {
	value *Api1AnyOf
	isSet bool
}

func (v NullableApi1AnyOf) Get() *Api1AnyOf {
	return v.value
}

func (v *NullableApi1AnyOf) Set(val *Api1AnyOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApi1AnyOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApi1AnyOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApi1AnyOf(val *Api1AnyOf) *NullableApi1AnyOf {
	return &NullableApi1AnyOf{value: val, isSet: true}
}

func (v NullableApi1AnyOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApi1AnyOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
