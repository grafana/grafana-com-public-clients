...
func Test_gcom_InstancesAPIService(t *testing.T) {
	...
	t.Run("Test InstancesAPIService GetInstanceReadiness", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var instanceId string

		resp, httpRes, err := apiClient.InstancesAPI.GetInstanceReadiness(context.Background(), instanceId).Execute()
	...
	t.Run("Test InstancesAPIService GetInstanceServiceAccountsSearch", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var instanceId string

		resp, httpRes, err := apiClient.InstancesAPI.GetInstanceServiceAccountsSearch(context.Background(), instanceId).Execute()
